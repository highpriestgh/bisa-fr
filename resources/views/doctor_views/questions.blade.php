    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active">
                    <a href="#"><i class="menu-icon fa fa-arrow-right"></i>Nouvelles Questions </a>
                </li>
                ...
                <li>
                    <a href="<?php echo Config::get('constants.USER_APP_DIRECTORY'); ?>/doctor/account-settings"><i class="menu-icon fa fa-cog text-info"></i>Paramètres Du Compte </a>
                </li>
